...
const quoteResults = await Promise.all(syms.map(async (sym, idx) => {
    ...
    if (endpoint === 'etfs') {
      ...
      const ETF_META = {
        ...
        'IVV':    { ter: 0.03, tob: 1.32 },
        'SPY':    { ter: 0.09, tob: 1.32 },
        'VOO':    { ter: 0.03, tob: 1.32 },
        'VTI':    { ter: 0.03, tob: 1.32 },
        'QQQ':    { ter: 0.20, tob: 1.32 },
        'VEA':    { ter: 0.05, tob: 1.32 },
        'VWO':    { ter: 0.08, tob: 1.32 },
        'VGK':    { ter: 0.09, tob: 1.32 },
        'VNQ':    { ter: 0.12, tob: 1.32 },
        'VPL':    { ter: 0.08, tob: 1.32 },
        'VXUS':   { ter: 0.07, tob: 1.32 },
        'VT':     { ter: 0.07, tob: 1.32 },
        'SCHD':   { ter: 0.06, tob: 1.32 },
        'SOXX':   { ter: 0.35, tob: 1.32 },
        'SMH':    { ter: 0.35, tob: 1.32 },
        'AMLP':   { ter: 0.85, tob: 1.32 },
        'ICLN':   { ter: 0.40, tob: 1.32 },
        'IGV':    { ter: 0.41, tob: 1.32 },
        'IGF':    { ter: 0.40, tob: 1.32 },
        'IHI':    { ter: 0.40, tob: 1.32 },
        'IYW':    { ter: 0.40, tob: 1.32 },
        'INDA':   { ter: 0.65, tob: 1.32 },
        'EWY':    { ter: 0.57, tob: 1.32 },
        'AAXJ':   { ter: 0.69, tob: 1.32 },
        'COPX':   { ter: 0.65, tob: 1.32 },
        'URA':    { ter: 0.69, tob: 1.32 },
        'XLE':    { ter: 0.09, tob: 1.32 },
        'XLI':    { ter: 0.09, tob: 1.32 },
        ...
        'LCUW.DE':  { ter: 0.12, tob: 0.12 },
        'ACWD.PA':  { ter: 0.17, tob: 0.12 },
        'PRIW.DE':  { ter: 0.05, tob: 0.12 },
        'PRAW.DE':  { ter: 0.05, tob: 0.12 },
        ...
        'GDX.DE':   { ter: 0.51, tob: 0.12 },
        'GDX.MI':   { ter: 0.51, tob: 0.12 },
        'IAUP.DE':  { ter: 0.55, tob: 0.12 },
        ...
        'SP5C.PA':  { ter: 0.05, tob: 0.12 },
        'CSE6.SW':  { ter: 0.18, tob: 0.12 },
        'STOXX.PA': { ter: 0.16, tob: 0.12 },
        ...
        'GLDM':     { ter: 0.10, tob: 1.32 },
        'GLD':      { ter: 0.40, tob: 1.32 },
        'SLV':      { ter: 0.50, tob: 1.32 },
        'PPLT':     { ter: 0.60, tob: 1.32 },
      };
