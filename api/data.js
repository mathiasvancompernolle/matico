    ...
    if (endpoint === 'etfs') {
      ...
      const ETF_LIJSTEN = {
        aandelen: [
          ...
          // Medium AUM (1-10 mld)
          'CNDX.AS','CNDX.PA','CNX1.L','ANAU.MI','NASL.MI','PRIW.DE','WEBN.DE','F50A.DE',
          ...
          'MEUD.L','MEUD.PA','LYP6.DE','DEFS.PA','ESE.PA','PABUS.MI','PAPU.MI','PAEEM.PA','PAASI.PA','PUST.PA','PANXG.PA',
          'LYSP5.SW','C6E.SW','C6E.PA','AME6.DE','AME6.F','CSE6.SW','PABG.L','EPAB.PA','PAEP.L',
          'EBLU.DE','BPAC.PA','CEUD.MI','BINFG.MI',
