    ...
    if (endpoint === 'etfs') {
      ...
      const ETF_LIJSTEN = {
        aandelen: [
          ...
          'IUSQ.DE','WSML.DE','ICLN','IQQH.DE','INRG.MI','CLEA.MI',
          ...
          'VUKE.L','VGK','IEUA.AS','EUSC.DE','SLMC.DE','IUSK.DE','SLUS.DE','GPSA.L','IESE.DE',
          // Sector & thema
          ...
          'IGF','INFR.MI','GLRE.L',
          'IPRV.SW','IPRV.SW','AAXJ','ICHN.AS','ISDE.L','SUSM.L','ISDU.L','ICGA.AS','AAXJ','EWY','IESH.MI',
          'QDVX.DE','QDVA.DE','CBUC.DE','EDMU.DE','SAUA.MI','EMUE.DE','WQDE.DE','IWDE.DE','IWDH.MI',
          ...
          'CHDVD.SW','SPAG.L','ISAG.MI','SPAG.MI','CBUC.DE','EDMU.DE','SAUA.MI','EMUE.DE',
          'SGAJ.DE','XMJP.DE','XZWD.DE','XMUS.L','XMUK.L',
          'SLMC.DE','IUSK.DE','SLUS.DE','GPSA.L','IESE.DE','IWY','SCHD',
        ],
        obligaties: [
