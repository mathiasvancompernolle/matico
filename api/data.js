    ...
    if (endpoint === 'etfs') {
      ...
      const ETF_LIJSTEN = {
        aandelen: [
          ...
          'SEC0.DE','SEC0.DE','SEMI.DE','SEMI.MI','SEMI.AS','SMH','SMH.DE','SMH.MI','SOXX',
          ...
          'EUNN.DE','SJPA.MI','SJPA.L','CJPA.SW','JPNH.SW','IJPA.MI','EXS2.DE','IJSE.DE','IJPN.AS',
          'IAEX.AS','EUEA.AS','SXRT.DE','CSSX5E.MI','EXV1.DE','ISF.SW','CUKX.SW','H50E.SW',
          'TDIV.AS','TGET.AS','TRET.AS',
          'VUKE.L','VGK','IEUA.AS','EUSC.DE','SLMC.DE','IUSK.DE','IESE.DE',
          // Sector & thema
          ...
          'IGF','INFR.MI','GLRE.L',
          'IPRV.SW','IPRV.SW','AAXJ','ICHN.AS','ISDE.L','SUSM.L','ICGA.AS','AAXJ','EWY','IESH.MI',
          'QDVX.DE','QDVA.DE','EMUE.DE','WQDE.DE','IWDE.DE','IWDH.MI',
