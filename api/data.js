    ...
    if (endpoint === 'etfs') {
      ...
      const ETF_LIJSTEN = {
        aandelen: [
          ...
          // Medium AUM (1-10 mld)
          'CNDX.L','CNDX.AS','CNDX.PA','CNX1.L','ANAV.DE','PRIW.DE','WEBN.DE','F50A.DE',
          ...
          'IAEX.AS','IUES.SW','IUSE.MI','EUEA.AS','SXRT.DE','CSSX5E.MI','EXV1.DE','ISF.SW','CUKX.SW','H50E.SW',
          ...
          'QDVX.DE','QDVW.DE','QDVE.DE','QDVA.DE','CBUC.DE','EDMU.DE','SAUA.MI','EMND.DE','EMUE.DE','SAWD.SW','SNAW.DE','WQDE.DE','IWDE.DE','IWDE.MI','IWDH.MI',
