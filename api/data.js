  ...
  try {
    ...
    if (endpoint === 'aandelen-regio') {
      ...
      const componenten = {
        ...
        'bel-midcap': ['IMMO.BR','KIN.BR','ATEB.BR','TITC.BR','SHU.BR','IBA.BR','BPOST.BR','CFEB.BR','JENS.BR','VGP.BR','RET.BR','HOMI.BR','INTO.BR','WEB.BR','MOURY.BR','TINC.BR','ONTEX.BR','WHATS.BR','ROU.BR','MELE.BR'],
