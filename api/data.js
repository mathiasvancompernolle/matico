  ...
  try {
    ...
    if (endpoint === 'aandelen-regio') {
      ...
      const componenten = {
        ...
        nasdaq: [
          'NVDA','GOOGL','AAPL','MSFT','AMZN','AVGO','TSLA','META',
          'MU','AMD','ASML','INTC','AMAT','LRCX','CSCO','ARM',
          'COST','KLA','NFLX','SNDK','PLTR','TXN','MRVL','WDC',
          'STX','QCOM','LIN','PANW','ADI','TMUS','PEP','AMGN',
          'CRWD','APP','GILD','ISRG','SHOP','BKNG','SBUX','VRTX',
          'PDD','CDNS','FTNT','MAR','CEG','MNST','ADP','SNPS',
          'CSX','ABNB','MELI','CMCSA','DDOG','NXPI','ADBE','MDLZ',
          'MPWR','DASH','ROST','INTUIT','ORLY','AEP','CINTAS',
          'WBD','PCAR','REGN','BKR','MCHP','FAST','FANG','EA',
          'FER','XEL','EXC','ODFL','TTWO','IDXX','CCEP','KDP',
          'ADSK','MSTR','PYPL','ALNY','PAYX','TRI','AXON','ROP',
          'WDAY','GEHC','CPRT','DXCM','KHC','VRSK','INSM',
          'CTSH','ZS','CHTR','CSGP',
        ],
